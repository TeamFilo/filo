...
<jsp:include page="/WEB-INF/views/include/header.jsp" />
	...
	<div class="wrapAll client">
		...
		<form action="/filo/land/landWritePro.fl" name="inputForm" onsubmit="return validation()" method="post">
			...
			<%-- <table>
				...
				<tr>
					<td colspan="2">
						...
						<input type="button" value="취소" onclick="window.location='/filo/client/landmark/landmark.fl'"/>
					</td>
			</table> --%>
		...
		<div class="btnWrap">
			...
			<p class="btn btnC" onclick="window.location='/filo/client/landmark/landmark.fl'">취소</p>
		</div>
		</form>
