...
<jsp:include page="/WEB-INF/views/include/header.jsp" />
	...
	<div class="wrapAll client">
		...
		<form action="/filo/travel/makingReqPro.fl" name="inputForm" onsubmit="return validation()" method="post">
		...
		<div class="btnWrap">
			...
			<a href="/filo/travel/makingList.fl"><p class="btn btnC">리스트</p></a>
		</div>
