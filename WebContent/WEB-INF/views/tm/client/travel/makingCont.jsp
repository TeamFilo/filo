...
<jsp:include page="/WEB-INF/views/include/header.jsp" />
	...
	<div class="wrapAll client">
		...
		<form action="makingDel.fl?gNo=${content.gNo}" name="removefrm" method="post"></form>
		...
		<c:if test="${sessionScope.memId eq 'admin'}">
			<button onclick="window.location='/filo/admin/adminGroupDel.fl?gNo=${content.gNo}'" style="color:red">그룹삭제</button>
		</c:if>
			<div class="titWrap">
		...
		<div class="btnWrap">			
			<c:if test="${sessionScope.memId!=content.id && content.status==0 && memStatus==-1}">
				...
				<a href="/filo/travel/makingReq.fl?gNo=${content.gNo}"><p class="btn btnY">신청</p></a>
				<a href="/filo/travel/makingList.fl?pageNum=${pageNum}"><p class="btn btnC">뒤로</p></a>
				</c:if>						
			...
			<c:if test="${sessionScope.memId!=content.id && memStatus==1}">
				...
				<a href="/filo/travel/groupSpace.fl?gNo=${content.gNo}"><p class="btn btnY">그룹 공간으로</p></a>
			</c:if>
			...
			<c:if test="${memId eq 'admin'}"> 
				<a href="/filo/admin/adminGroup.fl"><p class="btn btnY">리스트</p></a>
			</c:if>
			<c:if test="${memId ne 'admin'}"> 
				<a href="/filo/travel/makingList.fl?pageNum=${pageNum}"><p class="btn btnY">리스트</p></a>
			</c:if>
