...
<jsp:include page="/WEB-INF/views/include/header.jsp" />
	...
	<div class="wrapAll client">
		...
		<script>
			...
			*/
				$('.liked').submit(function(event){
					...
					console.log("좋아요호출");
					$.ajax({
						url: "/filo/travel/galleryLiked.fl",
						cache: false,	//재호출을 위함
						type: "POST",
						dataType: "json",
				...
				$('.likedCancel').submit(function(event){
					...
					console.log("취소호출");
					$.ajax({
						url: "/filo/travel/galleryLikedCancel.fl",
						cache: false,	//재호출을 위함
						type: "POST",
						dataType: "json",
						contentType: "application/json",
		...
		<div class="gsWrap">
         ...
         <ul class="gsMenu">
            <li><a href="groupSpace.fl?gNo=${grp.gNo}">그룹홈</a></li>
            <li class="on"><a href="gallery.fl?gNo=${grp.gNo}">갤러리${gNo}</a></li>
         </ul>
         ...
         <div class="gsCont gsGal">
            ...
            <form action="/filo/travel/uploadPro.fl" method="post" enctype="multipart/form-data">
						...
						<li>
							<c:if test="${list.isLiked==1}">
								<form class="likedCancel" method="post">
									...
									<p class="tic1"><span><input type="image" src="../resources/images/tm/heart-colored.png" width="12" alt="좋아요취소"/></span>${list.writer}님의 사진</p>
									<img src="/filo/save/${list.pRoot}" width="500"/>
									<br/>
							...
							<c:if test="${list.isLiked==0}">
								<form class="liked" method="post">
									...
									<input type="hidden" value="${list.gNo}" name="gNo"/>
									<input type="hidden" value="${list.pNo}" name="pNo"/>
									<p class="tic1"><span><input type="image" src="../resources/images/tm/heart-empty.png" width="12" alt="좋아요"/></span>${list.writer}님의 사진</p>
									<img src="/filo/save/${list.pRoot}" width="500"/>
									<br/>
									<p class="tic1">좋아요 <b class="cnt">${list.likedCnt}</b> 개</p>									
								</form>
