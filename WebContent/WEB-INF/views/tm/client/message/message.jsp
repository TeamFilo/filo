	...
	<div class="wrapAll client">
		...
		<div class="msWrap">
			...
			<div id="ms1" class="msCont">			
				...
				<c:if test="${recMsgCnt > 0}">
				<form action="messageDel.fl" method="get">
						...
						<li>
							...
							<ul style="display:none;">
								<li>
									...
									<input type="button" name="dap" value="답장" class="btn btnY" onclick="window.location='messageWrite.fl?reply=${recMsgList.sender}'" />
								</li>								
							</ul>
						</li>
						</c:forEach>
