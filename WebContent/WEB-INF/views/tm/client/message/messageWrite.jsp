...
<jsp:include page="/WEB-INF/views/include/header.jsp" />
	...
	<div class="wrapAll client">
		...
		<div class="msWrap">
			...
			<form action="/filo/msg/messageWritePro.fl" name="messageWrite" onsubmit="return check()" method="get">
			<div class="msWrite"> 
			...
			<div class="btnWrap">
				...
				<p onclick="window.location='/filo/msg/message.fl'" class="btn btnC">취소</p>
			</div>
			</form>
