   ...
   <!-- //top end -->
	...
	$(document).ready(function () {
		$('#group').change(function () {
			...
			$.ajax({
				type : "get",
				url : "/filo/cmt/selectTravel.fl",   //요청할 컨트롤러
				dataType : "json",
	...
	<h2 class="pageTit" data-aos="fade-right" data-aos-duration="600">
      ...
      <img src="/filo/resources/images/tm/myhomeimg.png"></img>
	...
	<div id="cont1">
		<c:if test="${count == 0}">
			...
			<button onclick="window.location='/filo/travel/makingList.fl'">여행떠나기</button>
		</c:if>
		<c:if test="${count >0}">
			<c:if test="${empty cmtMyGroup}">
      ...
      <!-- //cont1 end  -->   
	<div id="cont2">
		<form action="/filo/cmt/commentWritePro.fl" class="cWrite" name="commentWrite" onsubmit="return check()" method="get">
