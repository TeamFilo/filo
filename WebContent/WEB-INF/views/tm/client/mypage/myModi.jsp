			...
			<div class="mArticle">
				...
				<div class="wrapModi">
					...
					<div class="boxManage">
						...
						<div class="boxSet">
							<a href="myModiNick.fl?id=${mem.id}&nickname=${mem.nickname}" class="linkSet">
								<strong class="titSet">닉네임</strong>
								<span class="txtSet">${mem.nickname} ></span>
							</a>
						</div>
						<div class="boxSet">
							<a href="myModiPwForm.fl?id=${mem.id}&pw=${mem.pw}" class="linkSet">
					...
					<div class="boxManage">
						<input type="button" class="deleBtn" value="회원 탈퇴" onclick="window.location='/filo/mem/myDelete.fl?id=${mem.id}'"/>
					</div>
				</div>
			</div>
		</div>
