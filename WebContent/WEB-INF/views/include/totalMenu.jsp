...
<script>
    ...
    $('#totalMenuWrap > ul > li > .depth').hover(function(){
        $(this).prev('.tit_depth').addClass('on');
    },function(){
        $(this).prev('.tit_depth').removeClass('on');
    });
	...
	if(nowUrl === "/filo/index.fl"){	//portfolio
		$('.total_depth_main').prev('.tit_depth').addClass('on');
	}else if(nowUrl === "/filo/profile/main.fl"){	//profilie
		$('.total_depth_profile').prev('.tit_depth').addClass('on');
		...
		$('.total_depth_game').prev('.tit_depth').addClass('on');
		...
		$('.total_depth_guide').prev('.tit_depth').addClass('on');
		$('.total_depth_guide > li').eq(0).addClass('on');
	}else if(nowUrl === "/filo/mem/index.fl"){	//travel maker
		$('.total_depth_travelmaker').prev('.tit_depth').addClass('on');
