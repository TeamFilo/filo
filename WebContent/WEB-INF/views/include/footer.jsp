...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
	...
	$('.clickMenu').click(function(e) {
		...
		console.log(userId);
		$('#divView').empty().append('<div style="position:absolute;top:5px;right:5px"><span id="close" style="cursor:pointer;font-size:1.5em" title="닫기">x</span> </div><a href="/travelMaker/mem/userHistory.fl?userId='+userId+'">이력보기</a><br/><a href="/travelMaker/msg/messageWrite.fl?receiver='+userId+'">쪽지 보내기</a>');
		$('#divView').css({
			"top": divTop,
			"left": divLeft,
			"position": "absolute",
