...
public class LandmarkController {
	...
	public String landmark(Model model) throws Exception{
		...
		return "tm/client/landmark/landmark";
	}
	
	// 랜드마크 페이지 데이터 가져오기 ajax 요청 
	@RequestMapping("landmarkList.fl")
	@ResponseBody
	...
	//랜드마크 클릭 시 랜드마크 가져오기
	@ResponseBody
	@RequestMapping("landmarkCont.fl")
	...
	// 랜드마크 작성 페이지
	@RequestMapping("landWrite.fl")
	public String landWriteForm(LandmarkBoardDTO dto) throws Exception{
		
		return "tm/client/landmark/landWriteForm";
	}
	
	// 랜드마크 프로 페이지
	@RequestMapping("landWritePro.fl")
	public String landWritePro(LandmarkBoardDTO dto, Model model) throws Exception {
		...
		return "tm/client/landmark/landWritePro";
	}
	
	//내가 작성한 랜드마크
	@ResponseBody
	@RequestMapping("myWrittenLand.fl")
	...
	//유저가 작성한 랜드마크
	@ResponseBody
	@RequestMapping("userWrittenLand.fl")
	...
	@ResponseBody
	@RequestMapping("landmarkLiked.fl")
